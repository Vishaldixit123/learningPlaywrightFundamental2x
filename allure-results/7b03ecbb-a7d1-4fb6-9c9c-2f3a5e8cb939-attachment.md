...
Expected value:  ["You successfully clicked an aler"]
      ...
      - main [ref=e525]:
        ...
        - generic [ref=e536]:
          - generic [ref=e537]:
            - article [ref=e538]:
              ...
              - generic [ref=e556]: "{ \"type\": \"prompt\", \"value\": \"Vishal\", \"at\": \"8:38:32 PM\" }"
            - article [ref=e557]:
              ...
              - generic [ref=e572]: "{ \"action\": \"close\", \"id\": \"modal-stacked-backdrop\", \"reason\": \"escape\", \"stackSize\": 0 }"
        ...
        - region "JavaScript Alerts mini practice" [ref=e607]:
          - generic [ref=e608]:
            ...
            - generic [ref=e618]:
              - button "Click for JS Alert" [active] [ref=e619] [cursor=pointer]
              - button "Click for JS Confirm" [ref=e620] [cursor=pointer]
              - button "Click for JS Prompt" [ref=e621] [cursor=pointer]
            - paragraph [ref=e622]: "Result: You successfully clicked an alert"
...
```ts
  ...
  54 | 
  55 |     let values: string[] = ['You successfully clicked an aler']
  ...
  61 |     })
  62 | 
  63 |     await page.getByRole('button', { name: 'Click for JS Alert' }).click();
  64 | 
  65 |     let result = await page.getByTestId('alerts-result').textContent();
> 66 |     expect(result).toContainEqual(values);
     |                    ^ Error: expect(received).toContainEqual(expected) // deep equality
  67 | 
  68 | 
  69 | 
