...
- Location: tests/06_Select_DropDown/01_select_dropdown.spec.ts:20:5
...
Call log:
  - waiting for getByRole('option', { name: 'Vue' })
        ...
        - region "Custom dropdowns workspace" [ref=e534]:
          - generic [ref=e535]:
            ...
            - generic [ref=e552]:
              ...
              - button "Web framework" [active] [ref=e555] [cursor=pointer]:
            ...
            - generic [ref=e564]:
              ...
              - button "Experience level" [ref=e567] [cursor=pointer]:
              ...
              - generic [ref=e571]:
                ...
                - generic [ref=e574]:
                  - generic [ref=e575]: data-testid
                  - text: =dropdown-experience · experience-trigger
            - generic [ref=e576]:
              - button "Save selection" [ref=e577] [cursor=pointer]
              - button "Reset" [ref=e578] [cursor=pointer]
            - generic [ref=e579]: No selection yet — pick from the three dropdowns above.
          - complementary [ref=e580]:
            - generic [ref=e581]:
              - heading "What students should practise" [level=3] [ref=e582]
              - list [ref=e583]:
                - listitem [ref=e584]:
                  - text: Click the
                  - code [ref=e585]: .select-trigger
                  - text: matching a placeholder, then click an
                  - code [ref=e586]: option
                  - text: by visible text.
                - listitem [ref=e587]:
                  - text: "Write a reusable helper:"
                  - code [ref=e588]: selectValue(page, label, value)
                  - text: .
                - listitem [ref=e589]: Assert the trigger's visible text equals the chosen value after selection.
                - listitem [ref=e590]:
                  - text: Confirm only one option is marked
                  - code [ref=e591]: .is-selected
                  - text: per dropdown.
            - group [ref=e592]:
              - generic "Playwright solution Helper-based pattern — reusable across all three dropdowns. Show solution" [ref=e593] [cursor=pointer]:
                - img [ref=e595]
                - generic [ref=e597]:
                  - strong [ref=e598]: Playwright solution
                  - generic [ref=e599]: Helper-based pattern — reusable across all three dropdowns.
                - generic [ref=e600]: Show solution
```
...
> 7  |     await page.getByRole('option', { name: value }).click();
     |                                                     ^ Error: locator.click: Test timeout of 30000ms exceeded.
  ...
  12 | }
  13 | 
  14 | async function selectAllValue(page: Page, salector: string): Promise<string[]> {
  15 |     await page.locator(salector).click();
  16 |     let allValue: string[] = await page.getByRole('option').allInnerTexts();
  17 |     return allValue;
  18 | }
  19 | 
  20 | test('Select option', async ({ page }) => {
  21 |     await page.setViewportSize({ width: 1800, height: 900 });
  22 |     await page.goto('https://app.thetestingacademy.com/playwright/tables/dropdowns');
  23 |     await selectValue(page, 'Python', '#lang-trigger');
  24 | 
  25 |     let values: string[] = await selectAllValue(page, '#framework-trigger');
  26 |     ;
  27 | 
  28 |     for (let value of values) {
  29 |         console.log(value);
  30 |     }
  31 |     await selectValue(page, 'Vue', '#framework-trigger');
  32 |     await selectValue(page, 'Mid-level (4-6 years)', '#experience-trigger');
  33 | 
  34 |     await page.getByRole('button', { name: 'Save selection' }).click();
  35 | 
  36 | 
  37 | 
  38 | })
