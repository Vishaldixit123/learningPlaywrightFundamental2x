...
Expected substring: "Vishal Dixit"
Received string:    "—"
```
        ...
        - generic [ref=e536]:
          - generic [ref=e537]:
            - article [ref=e538]:
              ...
              - generic [ref=e556]: No native dialog interaction yet.
            - article [ref=e557]:
              ...
              - generic [ref=e572]: No modal interaction yet.
...
```ts
  ...
  54 | 
  55 |     // const expectedText = 'You successfully clicked an alert';
  56 |     // page.once('dialog', async (dialog) => {
  57 |     //     console.log(dialog.type());
  58 |     //     console.log(dialog.message());
  59 |     //     dialog.accept();
  60 |     // });
  61 | 
  62 |     // await page.getByRole('button', { name: 'Click for JS Alert' }).click();
  63 | 
  64 |     // const result = await page.getByTestId('alerts-result').textContent();
  65 |     // expect(result).toContain(expectedText);
  66 | 
  67 | 
  68 |     let name: string = "Vishal Dixit"
  69 | 
  70 |     page.once('dialog', async (dialog) => {
  71 |         console.log(dialog.type());
  72 |         console.log(dialog.message());
  73 |         dialog.accept(name);
  74 |     });
  75 |     const result = await page.getByTestId('alerts-result').textContent();
> 76 |     expect(result).toContain(name);
     |                    ^ Error: expect(received).toContain(expected) // indexOf
  77 | 
  78 | 
  79 | 
