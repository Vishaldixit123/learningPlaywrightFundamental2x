...
- Location: tests/06_Select_DropDown/01_select_dropdown.spec.ts:13:5

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('option', { name: 'Java' }) resolved to 2 elements:
    1) <div role="option" data-value="Java" class="select-option">…</div> aka getByRole('option', { name: 'Java', exact: true })
    2) <div role="option" class="select-option" data-value="JavaScript">…</div> aka getByRole('option', { name: 'JavaScript' })

Call log:
  - waiting for getByRole('option', { name: 'Java' })
        ...
        - region "Custom dropdowns workspace" [ref=e534]:
          - generic [ref=e535]:
            - generic [ref=e536]:
              ...
              - generic [ref=e538]:
                - button "Programming language" [expanded] [active] [ref=e539] [cursor=pointer]:
                  - generic [ref=e540]: Choose your preferred programming language
                  - img [ref=e541]
                - listbox [ref=e543]:
                  - option "Java" [ref=e544] [cursor=pointer]:
                    - text: Java
                    - img [ref=e545]
                  - option "Python" [ref=e547] [cursor=pointer]:
                    - text: Python
                    - img [ref=e548]
                  - option "JavaScript" [ref=e550] [cursor=pointer]:
                    - text: JavaScript
                    - img [ref=e551]
                  - option "TypeScript" [ref=e553] [cursor=pointer]:
                    - text: TypeScript
                    - img [ref=e554]
                  - option "Ruby" [ref=e556] [cursor=pointer]:
                    - text: Ruby
                    - img [ref=e557]
                  - option "Go" [ref=e559] [cursor=pointer]:
                    - text: Go
                    - img [ref=e560]
                  - option "C#" [ref=e562] [cursor=pointer]:
                    - text: C#
                    - img [ref=e563]
              - generic [ref=e565]:
                - generic [ref=e566]:
                ...
                - generic [ref=e570]:
                  - generic [ref=e571]: class
                  - text: =select-trigger
                - generic [ref=e572]:
                  - generic [ref=e573]: option
                  - text: role=option · data-value=Java/Python/…
            - generic [ref=e574]:
              - generic [ref=e575]: Web framework
              - button "Web framework" [ref=e577] [cursor=pointer]:
                - generic [ref=e578]: Choose your preferred web framework
                - img [ref=e579]
              - generic [ref=e581]:
                - generic [ref=e582]:
                  - generic [ref=e583]: id
            ...
            - generic [ref=e586]:
              - generic [ref=e587]: Experience level
              - button "Experience level" [ref=e589] [cursor=pointer]:
                - generic [ref=e590]: Select your experience level
                - img [ref=e591]
              - generic [ref=e593]:
                - generic [ref=e594]:
                  - generic [ref=e595]: id
            ...
            - generic [ref=e598]:
              - button "Save selection" [ref=e599] [cursor=pointer]
              - button "Reset" [ref=e600] [cursor=pointer]
            - generic [ref=e601]: No selection yet — pick from the three dropdowns above.
          - complementary [ref=e602]:
            - generic [ref=e603]:
              - heading "What students should practise" [level=3] [ref=e604]
              - list [ref=e605]:
                - listitem [ref=e606]:
                  - text: Click the
                  - code [ref=e607]: .select-trigger
                  - text: matching a placeholder, then click an
                  - code [ref=e608]: option
                  - text: by visible text.
                - listitem [ref=e609]:
                  - text: "Write a reusable helper:"
                  - code [ref=e610]: selectValue(page, label, value)
                  - text: .
                - listitem [ref=e611]: Assert the trigger's visible text equals the chosen value after selection.
                - listitem [ref=e612]:
                  - text: Confirm only one option is marked
                  - code [ref=e613]: .is-selected
                  - text: per dropdown.
            - group [ref=e614]:
              - generic "Playwright solution Helper-based pattern — reusable across all three dropdowns. Show solution" [ref=e615] [cursor=pointer]:
                - img [ref=e617]
                - generic [ref=e619]:
                  - strong [ref=e620]: Playwright solution
                  - generic [ref=e621]: Helper-based pattern — reusable across all three dropdowns.
                - generic [ref=e622]: Show solution
```
...
```ts
  ...
  2  | 
  3  | async function selectValue(page: Page, value: string): Promise<void> {
  4  | 
  5  |     await page.locator('#lang-trigger').click();
  6  |     await page.pause();
> 7  |     await page.getByRole('option', { name: value }).click();
  ...
  11 | }
  12 | 
  13 | test('Select option', async ({ page }) => {
  14 |     await page.setViewportSize({ width: 1800, height: 900 });
  15 |     await page.goto('https://app.thetestingacademy.com/playwright/tables/dropdowns');
  16 |     await selectValue(page, 'Java');
  17 | 
  18 | 
  19 | })
```