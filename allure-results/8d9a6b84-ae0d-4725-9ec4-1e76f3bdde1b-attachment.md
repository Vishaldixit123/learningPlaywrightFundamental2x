...
Call log:
  - waiting for locator('#pact1').contentFrame().locator('#pact2').contentFrame().getByLabel('Language used at this level', { exact: true })
      ...
      - banner [ref=e502]:
        ...
        - generic [ref=e506]:
          - link "Practice" [ref=e507] [cursor=pointer]:
            - /url: ../index.html
          - img [ref=e508]
          - generic [ref=e510]: Frames
          - img [ref=e511]
          - strong [ref=e513]: Nested iframes
        - generic [ref=e514]:
          - generic [ref=e515] [cursor=pointer]:
            - checkbox "Locator markers" [checked] [ref=e516]
            - generic [ref=e517]: Locator markers
          - generic [ref=e518]: 3 levels deep
          - button "Toggle dark mode" [ref=e519] [cursor=pointer]:
            - img [ref=e520]
            - img [ref=e522]
      - main [ref=e525]:
        - region "Three deeply nested iframes" [ref=e526]:
          - generic [ref=e527]: Frame practice · Nested iframes
          - heading "Three deeply nested iframes" [level=1] [ref=e529]:
            - text: Three
            - emphasis [ref=e530]: deeply nested
            - text: iframes
          - paragraph [ref=e531]:
            - code [ref=e532]: iframe#pact1
            - text: contains
            - code [ref=e533]: iframe#pact2
            - text: ", which contains"
            - code [ref=e534]: iframe#pact3
            - text: — each level has its own input. Practise chained
            - code [ref=e535]: page.frameLocator().frameLocator()...
            - text: calls and assert the values at every depth.
        - region "Nested iframes workspace" [ref=e536]:
          - article [ref=e537]:
            - heading "Outer page · level 0" [level=3] [ref=e538]:
              - text: Outer page ·
              - emphasis [ref=e539]: level 0
            - iframe [active] [ref=e541]:
              - generic [ref=f1e1]:
                - generic [ref=f1e2]: Level 1 · iframe#pact1
                - heading "Frame one" [level=4] [ref=f1e3]
                - generic [ref=f1e4]: Tool used at this level
                - textbox "Tool used at this level" [ref=f1e5]:
                  - /placeholder: e.g. Testing
                  - text: Testing
                - paragraph [ref=f1e6]: "Locator: page.frameLocator('#pact1').locator('#inp_val')"
                - iframe [active] [ref=f1e8]:
                  - generic [ref=f2e1]:
                    - generic [ref=f2e2]: Level 2 · iframe#pact2
                    - heading "Frame two" [level=4] [ref=f2e3]
                    - generic [ref=f2e4]: Framework used at this level
                    - textbox "Framework used at this level" [active] [ref=f2e5]:
                      - /placeholder: e.g. Selenium
                      - text: Selenuim
                    - paragraph [ref=f2e6]: "Locator: frame1.frameLocator('#pact2').locator('#jex')"
                    - iframe [ref=f2e8]:
                      - generic [active] [ref=f3e1]:
                        - generic [ref=f3e2]: Level 3 · iframe#pact3
                        - heading "Frame three (deepest)" [level=4] [ref=f3e3]
                        - generic [ref=f3e4]: Language used at this level
                        - textbox "Language used at this level" [ref=f3e5]:
                          - /placeholder: e.g. Playwright
                        - paragraph [ref=f3e6]: "Locator: frame2.frameLocator('#pact3').locator('#glaf')"
                        - generic [ref=f3e7]: Deepest frame · no nested children
            - generic [ref=e542]:
              - generic [ref=e543]:
                - generic [ref=e544]: id
                - text: =pact1 · pact2 · pact3
              - generic [ref=e545]:
                - generic [ref=e546]: input ids
                - text: "=#inp_val · #jex · #glaf"
              - generic [ref=e547]:
                - generic [ref=e548]: outer header
                - text: =h3
            - paragraph [ref=e549]:
              - text: "Selector chain:"
              - strong [ref=e550]: page.frameLocator('#pact1').frameLocator('#pact2').frameLocator('#pact3').locator('#glaf')
          - complementary [ref=e551]:
            - generic [ref=e552]:
              - heading "What students should practise" [level=3] [ref=e553]
              - list [ref=e554]:
                - listitem [ref=e555]: Chain three frameLocator calls to reach the deepest input.
                - listitem [ref=e556]: Fill each level with a different value and assert the values back.
                - listitem [ref=e557]:
                  - text: Read the outer page's
                  - code [ref=e558]: h3
                  - text: and confirm it didn't change.
                - listitem [ref=e559]: Refill all three inputs with new values and assert again.
            - group [ref=e560]:
              - generic "Playwright solution Chained frameLocator() across three levels. Show solution" [ref=e561] [cursor=pointer]:
                - img [ref=e563]
                - generic [ref=e565]:
                  - strong [ref=e566]: Playwright solution
                  - generic [ref=e567]:
                    - text: Chained
                    - code [ref=e568]: frameLocator()
                    - text: across three levels.
                - generic [ref=e569]: Show solution
```
...
> 18 |     await frame2.getByLabel('Language used at this level', { exact: true }).fill('Playwright');
     |                                                                             ^ Error: locator.fill: Test timeout of 30000ms exceeded.
