...
Expected value:  ["You successfully clicked an alert"]
        ...
        - generic [ref=e536]:
          - generic [ref=e537]:
            - article [ref=e538]:
              ...
              - generic [ref=e556]: "{ \"type\": \"prompt\", \"value\": \"Vishal\", \"at\": \"8:37:16 PM\" }"
            - article [ref=e557]:
...
```ts
  ...
  56 |         console.log(dialog.type());
  57 |         console.log(dialog.message());
  58 |         dialog.accept()
  59 | 
  60 |     })
  61 |     await page.getByRole('button', { name: 'Click for JS Alert' }).click();
  62 | 
  63 |     let result = await page.getByTestId('alerts-result').textContent();
> 64 |     expect(result).toContainEqual(['You successfully clicked an alert']);
     |                    ^ Error: expect(received).toContainEqual(expected) // deep equality
  65 | 
  66 | 
  67 | 
