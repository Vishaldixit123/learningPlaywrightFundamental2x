...
- Name: 08_Keyword_Hover_DropDown/01_Hover.spec.ts >> Handle Nasted Frame
- Location: tests/08_Keyword_Hover_DropDown/01_Hover.spec.ts:3:5
...
Call log:
  - waiting for getByRole('link', { name: 'Hotel' })
      ...
      - main [ref=e525]:
        ...
        - generic [ref=e533]:
          - article [ref=e535]:
            ...
            - generic [ref=e552]: "{ \"clicked\": \"🛡️\\nInsurance\", \"testId\": \"test-id-Insurance\", \"at\": \"6:23:29 PM\" }"
...
> 8 |     await page.getByRole('link', { name: 'Hotel' }).click()
    |                                                     ^ Error: locator.click: Test timeout of 30000ms exceeded.
  9 | })
```