...
```
Error: locator.click: Unexpected token "/" while parsing css selector "[text()="Pune"]/ancestor::tr/td/input". Did you mean to CSS.escape it?
Call log:
  - waiting for //table/tbody[@id="employee-body"]/tr >> nth=0 >> //td >> nth=4 >> [text()="Pune"]/ancestor::tr/td/input
...
Call log:
  - waiting for locator('//table/tbody[@id="employee-body"]/tr').nth(8).locator('//td').nth(3)
...
> 16 |             if (await data[j].innerText() === 'Pune') {
     |                               ^ Error: locator.innerText: Test ended.
  17 |                 data[j].locator('[text()="Pune"]/ancestor::tr/td/input').click();
  18 |                 break;
  19 | 
  20 |             }
  21 |         }
